...
public class BillingandPaymentActivity extends SuperAppCompactActivity {
    ...
    class C03912 implements Callback<String> {
        ...
        class C03901 extends WebViewClient {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains("https://www.vurvhealth.com/my-members/")) {
                    Intent intent = new Intent(BillingandPaymentActivity.this, MyMembersActivity.class);
        ...
        public void onFailure(Call<String> call, Throwable t) {
            dismissProgressDialog();
            Toast.makeText(BillingandPaymentActivity.this, getResources().getString(R.string.server_not_found), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvheader.setText(getString(R.string.billing_account));
        webView.getSettings();
