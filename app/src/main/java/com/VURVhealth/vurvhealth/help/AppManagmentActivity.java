...
public class AppManagmentActivity  extends SuperAppCompactActivity {
    ...
    class C03912 implements Callback<String> {
        ...
        class C03901 extends WebViewClient {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains("https://www.vurvhealth.com/my-members/")) {
                    Intent intent = new Intent(AppManagmentActivity.this, MyMembersActivity.class);
        ...
        public void onFailure(Call<String> call, Throwable t) {
            dismissProgressDialog();
            Toast.makeText(AppManagmentActivity.this, getResources().getString(R.string.server_not_found), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvheader.setText(getString(R.string.vurvhealth_app));
        webView.getSettings();
