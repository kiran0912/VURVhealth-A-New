...
/**
 * Created by yqlabs on 25/5/17.
 */

public class HelpDocFacActivity extends SuperAppCompactActivity {
    ...
    class C03912 implements Callback<String> {
        ...
        class C03901 extends WebViewClient {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains("https://www.vurvhealth.com/my-members/")) {
                    Intent intent = new Intent(HelpDocFacActivity.this, MyMembersActivity.class);
        ...
        public void onFailure(Call<String> call, Throwable t) {
            dismissProgressDialog();
            Toast.makeText(HelpDocFacActivity.this, getResources().getString(R.string.server_not_found), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvheader.setText(getString(R.string.vurvhealth_medical));
        webView.getSettings();
