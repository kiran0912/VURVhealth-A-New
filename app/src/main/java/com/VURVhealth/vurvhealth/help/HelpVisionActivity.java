...
public class HelpVisionActivity extends SuperAppCompactActivity {
    ...
    class C03912 implements Callback<String> {
        ...
        class C03901 extends WebViewClient {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains("https://www.vurvhealth.com/my-members/")) {
                    Intent intent = new Intent(HelpVisionActivity.this, MyMembersActivity.class);
        ...
        public void onFailure(Call<String> call, Throwable t) {
            dismissProgressDialog();
            Toast.makeText(HelpVisionActivity.this, getResources().getString(R.string.server_not_found), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvheader.setText(getString(R.string.vurvhealth_vision));
        webView.getSettings();
    ...
    private void getTermsAndCondition() {
        ...
        try {
//            ((ApiInterface) retrofit.create(ApiInterface.class)).getPageContent(Application_holder.BASE_URL == Application_holder.AUTH_BASE_URL ? requestVURVTerms() : requestVURVTerms1()).enqueue(new C03912());
