...
public class DoctorVURVBannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        cardImg.setBackgroundResource(R.drawable.card_medical_new);
        ...
        cardImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DoctorVURVBannerActivity.this, UpgradeMedicalFlipActivity.class);
