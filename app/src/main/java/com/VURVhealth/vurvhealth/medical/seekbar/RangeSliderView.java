...
public class RangeSliderView extends View {
    ...
    private static final int DEFAULT_FILLED_COLOR = Color.parseColor("#00B3E3");
    ...
    public RangeSliderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        getResources().getValue(R.dimen.slide_bar_text, typedValue, true);
        float myFloatValue = typedValue.getFloat();

        paint1.setStrokeWidth(DEFAULT_PAINT_STROKE_WIDTH1);
        paint1.setTextSize(myFloatValue);
...
//    canvas.drawCircle(currentSlidingX, y0, radius, paint);
        ...
        if(currentIndex == 0) {
            canvas.drawText("0", currentSlidingX, yPos, paint1);
            ...
            canvas.drawText("50", currentSlidingX, yPos, paint1);
        }
