package com.VURVhealth.vurvhealth.medical.seekbar;
...
public class RangeSliderView1 extends View {

    private static final String TAG = RangeSliderView1.class.getSimpleName();
    ...
    private static final int DEFAULT_PAINT_STROKE_WIDTH1 = 1;

    private static final int DEFAULT_FILLED_COLOR = Color.parseColor("#005FB6");
    ...
    public RangeSliderView1(Context context) {
        this(context, null);
    }

    public RangeSliderView1(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public RangeSliderView1(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        paint1 = new Paint(Paint.DEV_KERN_TEXT_FLAG);
        paint1.setTextAlign(Align.CENTER);

        paint1.setStrokeWidth(DEFAULT_PAINT_STROKE_WIDTH1);
//    paint1.setStyle(Paint.Style.FILL_AND_STROKE);

        ripplePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        ripplePaint.setStrokeWidth(2.0f);
        ripplePaint.setStyle(Style.FILL_AND_STROKE);
    ...
    private void drawRippleEffect(Canvas canvas) {
        if (rippleRadius != 0) {
            ...
            outerPath.reset();
            outerPath.addCircle(downX, downY, rippleRadius, Direction.CW);
            canvas.clipPath(outerPath);
            innerPath.reset();
            innerPath.addCircle(downX, downY, rippleRadius / 3, Direction.CW);
            canvas.clipPath(innerPath, Op.DIFFERENCE);
...
//    canvas.drawCircle(currentSlidingX, y0, radius, paint);
        ...
        if(currentIndex == 1) {
            canvas.drawText("10", currentSlidingX, yPos, paint1);
        }else if(currentIndex == 2) {
            canvas.drawText("20", currentSlidingX, yPos, paint1);
        }else if(currentIndex == 3) {
            canvas.drawText("30", currentSlidingX, yPos, paint1);
        }else if(currentIndex == 4) {
            canvas.drawText("40", currentSlidingX, yPos, paint1);
        }
