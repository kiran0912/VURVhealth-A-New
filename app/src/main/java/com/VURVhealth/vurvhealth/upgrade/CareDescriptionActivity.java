...
//                startActivity(new Intent(CareDescriptionActivity.this, UpgradeSubscriptionActivity.class));
        ...
        tvRateBanner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CareDescriptionActivity.this,CarePaymentOptionsActivity.class);
...
//                finish();
    ...
    private void infoPrescCustomAlertDialog() {
        ...
        final Dialog customDialog = new Dialog(CareDescriptionActivity.this);
