...
public class PulseDescriptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("SubPackageId", Context.MODE_PRIVATE);
        String subPackageId = sharedPreferences.getString("sub_packageId","");
        String price = sharedPreferences.getString("price","");

        if(subPackageId.equalsIgnoreCase("372")){
            tvRateBanner.setText(getResources().getString(R.string.starting_at)+" $"+price+" / Month");
        }
...
//                startActivity(new Intent(PulseDescriptionActivity.this, UpgradeSubscriptionActivity.class));
                finish();
            }
        });
        ...
        tvRateBanner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PulseDescriptionActivity.this,PulsePaymentOptionsActivity.class);
    ...
    private void infoPrescCustomAlertDialog() {
        ...
        final Dialog customDialog = new Dialog(PulseDescriptionActivity.this);
