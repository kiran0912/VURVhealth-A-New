...
public class CarePaymentOptionsActivity extends SuperAppCompactActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recentDbHelper = new SqLiteDbHelper(CarePaymentOptionsActivity.this);
...
//        checkYear = (ImageView) findViewById(R.id.checkYear);
        ...
        tb_title.setText("Care");

        List<String> memberPick = new ArrayList<String>();
        memberPick.add("Single");
        memberPick.add("Spouse");
        memberPick.add("Family");
        ArrayAdapter<String> dataMemberAdapter = new ArrayAdapter<String>(CarePaymentOptionsActivity.this,
        ...
        singlePrices.add("Monthly - $16.95");
        singlePrices.add("3 Months - $50.85");
        singlePrices.add("6 Months - $101.70");
        singlePrices.add("12 Months - $203.40");
        singlePriceAdapter = new ArrayAdapter<String>(CarePaymentOptionsActivity.this,
                R.layout.spinner_item, R.id.tvspinner, singlePrices);

        List<String> spousePrices = new ArrayList<String>();
        spousePrices.add("Monthly - $21.95");
        spousePrices.add("3 Months - $65.85");
        spousePrices.add("6 Months - $131.70");
        spousePrices.add("12 Months - $263.40");
        spousePriceAdapter = new ArrayAdapter<String>(CarePaymentOptionsActivity.this,
                R.layout.spinner_item, R.id.tvspinner, spousePrices);

        List<String> familyPrices = new ArrayList<String>();
        familyPrices.add("Monthly - $26.95");
        familyPrices.add("3 Months - $80.85");
        familyPrices.add("6 Months - $161.70");
        familyPrices.add("12 Months - $323.40");
        familyPriceAdapter = new ArrayAdapter<String>(CarePaymentOptionsActivity.this,
...
//        memberPicker.setSelection(selectedNumber);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                startActivity(new Intent(CarePaymentOptionsActivity.this, CareDescriptionActivity.class));
                finish();
            }
        });
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*Intent intent = new Intent(CarePaymentOptionsActivity.this, BillingInfoActivity.class);
                startActivity(intent);*/
                if (tvSubPlan.getText().toString().contains(prefsLoginData.getString("post_title",""))){
                    Intent i = new Intent(CarePaymentOptionsActivity.this, BillingInfoActivity.class);
                    startActivity(i);
                }else {
                    ...
                    if (tvSubPlan.getText().toString().contains("Family") &&
                        ...
                        Intent i = new Intent(CarePaymentOptionsActivity.this, MyMembersActivity.class);
                        startActivity(i);
                    }
                }
    ...
    private void memberDeleteDialog(String member_type) {
        ...
        final Dialog customDialog = new Dialog(CarePaymentOptionsActivity.this);
