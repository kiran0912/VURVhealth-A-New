...
//            plan.setText(getString(R.string.plan) + " CARE");
            ...
            if (this.activity.equalsIgnoreCase("MyMembersActivity")) {
             ...
             //   vurv_id.setText("VURV  ID: " + this.secondaryUserVurvId);
                ...
                dobFormat = null;
                try {
                    dobFormat = new SimpleDateFormat("MM/dd/yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(UpgradeAltHealthFlipActivity.prefsData.getString("vurv_mem_exp_date", "12/12/2017")));
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
