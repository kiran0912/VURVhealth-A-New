...
public class PaymentOptions360Activity extends SuperAppCompactActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recentDbHelper = new SqLiteDbHelper(PaymentOptions360Activity.this);
...
//        checkYear = (ImageView) findViewById(R.id.checkYear);
        ...
        ArrayAdapter<String> dataMemberAdapter = new ArrayAdapter<String>(PaymentOptions360Activity.this,
        ...
        singlePrices.add("Monthly - $29.90");
        singlePrices.add("3 Months - $68.70");
        singlePrices.add("6 Months - $179.40");
        singlePrices.add("12 Months - $358.80");

        singlePriceAdapter = new ArrayAdapter<String>(PaymentOptions360Activity.this,
        ...
        spousePrices.add("3 Months - $131.70");
        spousePrices.add("6 Months - $131.70");
        spousePrices.add("12 Months - $442.80");

        spousePriceAdapter = new ArrayAdapter<String>(PaymentOptions360Activity.this,
                R.layout.spinner_item, R.id.tvspinner, spousePrices);

        List<String> familyPrices = new ArrayList<String>();
        familyPrices.add("Monthly - $36.90");
        familyPrices.add("3 Months - $110.70");
        familyPrices.add("6 Months - $221.40");
        familyPrices.add("12 Months - $323.40");

        familyPriceAdapter = new ArrayAdapter<String>(PaymentOptions360Activity.this,
...
*/
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                startActivity(new Intent(PaymentOptions360Activity.this, Description360Activity.class));
                finish();
            }
        });
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*Intent intent = new Intent(PaymentOptions360Activity.this, BillingInfoActivity.class);
                startActivity(intent);*/

                if (tvSubPlan.getText().toString().contains(prefsLoginData.getString("post_title",""))){
                    Intent i = new Intent(PaymentOptions360Activity.this, BillingInfoActivity.class);
                    startActivity(i);
                }else {
                    ...
                    if (tvSubPlan.getText().toString().contains("Family") &&
                        ...
                        Intent i = new Intent(PaymentOptions360Activity.this, MyMembersActivity.class);
                        startActivity(i);
                    }
                }
            }
    ...
    private void memberDeleteDialog(String member_type) {
        ...
        final Dialog customDialog = new Dialog(PaymentOptions360Activity.this);
