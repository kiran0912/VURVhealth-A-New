...
public class CustomAutocompleteText extends AutoCompleteTextView {
    ...
    public CustomAutocompleteText(final Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;

        CustomAutocompleteText.this.setFilters(new InputFilter[]{new InputFilter.AllCaps()});
...
//                Log.e("tag", "cursorBool>>>>>>>>>>>>>>>>>" + cursorBool + "   " + cursorPosition);
                ...
                if(cursorBool){
                    CustomAutocompleteText.this.setSelection(cursorPosition);
                    cursorBool=false;
                }
            }
            ...
            public void afterTextChanged(Editable s) {
                ...
                if(s.toString().length() > 0){
                    ...
                    if(!match.matches()){
                        ...
                        cursorBool=true;
                        CustomAutocompleteText.this.setText(test);
                        CustomAutocompleteText.this.setFilters(new InputFilter[]{new InputFilter.AllCaps()});
