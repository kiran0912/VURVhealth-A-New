package com.VURVhealth.vurvhealth.circleView;
...
/**
 * @author Roopa Creates a rotatable circle menu which can be parameterized by
...
//                destAngle = -1 * (180 - destAngle);

            }

         /*   if(viewAngle >= 150 && viewAngle <= 233){
//            speed = 3;
                animateTo(angle + destAngle, 4000);
            }else if(viewAngle > 233 && viewAngle <= 305){
//                speed = 5;
                animateTo(angle + destAngle, 3000);

            }else if(viewAngle >= 306){
//                speed = 9;
                animateTo(angle + destAngle, 2000);

            }else if(viewAngle <= 25){
//                speed = 13;
                animateTo(angle + destAngle, 1000);
            }else {
                animateTo(angle + destAngle, 2000);
            }
*/

            animateTo(angle + destAngle, 9000L / speed);
    ...
    private void animateTo(float endDegree, long duration) {
        ...
        /*double distance = 0.017452 * endDegree;
        long speed = 90l / 10;
        long dur = (long) (distance / speed) * 2000;
